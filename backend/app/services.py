...
def connect_automation(
    ...
    defaults = {
        ...
        "bio": project.description or project.goal or project.target_audience,
        "profile_image_url": project.logo_url,
        "account_url": user_settings.website_url or project.demo_url or project.repo_url,
        "company_name": project.name,
        "legal_entity_name": project.name,
        "company_start_date": user_settings.company_start_date,
        "website_url": user_settings.website_url or project.demo_url or project.repo_url,
        ...
        "brand_handle": "",
        "brand_bio": project.description or project.goal or project.target_audience,
